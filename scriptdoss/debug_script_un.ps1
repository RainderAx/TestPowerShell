...
#ajout de la fonction qui permet d'écrire dans la barre 
...
$button_generer.Add_Click({
    ...
    #ajout de la variable qui récupère le login
    ...
    ###
        ...
        #ajout de la créeation du fichier vers le dossier *le chemin sera à modifier*
        New-Item -Path "C:\Scripts\Alexis\$Login.txt" -ItemType File -Force
        $userData = "$Nom,$Prenom,$Bureau,$Login,$Telephone"
